...
const getCdnBaseUrl = (cdn) => (cdn === 'cn' ? '.' : '.');
...
function getMetaTagsAndIconLinks(opts) {
    ...
    const cdnBaseUrl = getCdnBaseUrl(cdn);
    const manifestUrlCom = './porsche-design-system/meta-icons/manifest.2bdf26ea31a4da66c7559db772445d32.webmanifest';
    const manifestUrlCn = './porsche-design-system/meta-icons/manifest.cn.7de567d4b65ef45bebd99dfc24aacd89.webmanifest';
