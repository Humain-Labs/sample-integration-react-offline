...
import { getMultiSelectOptionCss as getComponentCss$y } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRMultiSelectOption extends Component {
    ...
    render() {
        ...
        minifyCss(stripFocusAndHoverStyles(getComponentCss$y(theme)));
        return (jsx(Fragment, {}));
    }
}
